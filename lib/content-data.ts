...
export const defaultContent: SiteContent = {
  ...
  pages: [
    { id: "page-news", slug: "berita", eyebrow: "Kabar Terbaru", title: "Berita & Artikel", intro: "Ikuti terus perkembangan, kegiatan, dan cerita dari kami.", body: "", status: "published", updatedAt: "2026-09-17" },
    { id: "page-gallery", slug: "galeri", eyebrow: "Dokumentasi", title: "Galeri Kegiatan", intro: "Momen-momen berharga dan dokumentasi aktivitas di lingkungan panti asuhan kami.", body: "", status: "published", updatedAt: "2026-09-17" },
    { id: "page-contact", slug: "kontak", eyebrow: "Hubungi Kami", title: "Kami siap mendengar dari Anda", intro: "Silakan hubungi kami untuk informasi lebih lanjut mengenai panti asuhan, program, atau donasi.", body: "", status: "published", updatedAt: "2026-09-17" },
    { id: "page-organization", slug: "struktur-organisasi", eyebrow: "Profil Panti", title: "Struktur Pengurus & Pengelola", intro: "Struktur pengelolaan LKSA Panti Asuhan Muhammadiyah Sumur Bandung. Nama dan jabatan dapat diperbarui melalui dashboard CMS.", body: "Bersama menjalankan amanah pengasuhan\n\nPengurus, pengasuh, pendamping pendidikan, dan relawan bekerja bersama untuk menjaga layanan anak asuh.", status: "published", updatedAt: "2026-09-17" },
    { id: "page-schedule", slug: "jadwal-kegiatan", eyebrow: "Profil Panti", title: "Jadwal Kegiatan Panti", intro: "Jadwal kegiatan harian dan mingguan yang berlaku di panti asuhan kami.", body: "", status: "published", updatedAt: "2026-09-17" },
    { id: "page-donation", slug: "donasi", eyebrow: "Dukung Program", title: "Dokumen pendukung donasi", intro: "Dokumen resmi berikut disediakan untuk membantu calon donatur mengenal profil, legalitas, dan struktur pengelolaan LKSA.", body: "Mohon cek kembali nama rekening sebelum transfer dan konfirmasi melalui WhatsApp resmi LKSA.", status: "published", updatedAt: "2026-09-17" },

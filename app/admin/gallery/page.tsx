      ...
      <div className="max-w-6xl space-y-6 p-5 md:p-10">
        <form action={saveGalleryAction} className="grid gap-5 rounded-2xl border-2 border-dashed border-line bg-white p-6 shadow-subtle md:grid-cols-2">
          <div className="md:col-span-2">
            ...
            <p className="mt-1 text-sm text-muted">Tempel URL dari Media Library setelah upload berhasil.</p>
          </div>
          <label className="text-sm font-semibold md:col-span-2">URL gambar<input className={input} name="url" placeholder="https://media.example.com/uploads/foto.jpg" required /></label>
          <label className="text-sm font-semibold">Teks alternatif<input className={input} name="alt" placeholder="Anak asuh mengikuti kegiatan..." required /></label>

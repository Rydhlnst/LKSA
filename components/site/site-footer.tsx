...
export function SiteFooter({ settings }: { settings: SiteSettings }) {
  return <footer className="bg-navy text-white">
    ...
    <div className="border-t border-white/10"><div className="site-container flex flex-col gap-2 py-5 text-xs text-white/50 sm:flex-row sm:items-center sm:justify-between"><span>© {new Date().getFullYear()} {settings.organizationName}. Hak Cipta Dilindungi.</span><span>LKSA Muhammadiyah Sumur Bandung</span></div></div>
  </footer>;
}
